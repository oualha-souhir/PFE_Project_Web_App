...
const connectionString =
  "HostName=evcss.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=QO8cuHMEvqHMTjJmdDEtGcshe756aW4E+AIoTAgkR8E=";
var targetDevice = "evcs";

var serviceClient = Client.fromConnectionString(connectionString);
const eventHubName = "evcss";
const consumerGroup = "$Default";
const connectionString1 =
  "Endpoint=sb://iothub.servicebus.windows.net/;SharedAccessKeyName=iothubowner;SharedAccessKey=btR7Z4ekaIxCPU4/rwzhkEhkKrCiyF/0AAIoTD82eFg=;EntityPath=evcss";
